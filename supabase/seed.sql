...
insert into auth.users (
  ...
  ('00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000000',
   ...
   '{"provider":"email","providers":["email"]}', '{"nome":"Admin Global"}', now(), now(), '', '', '', ''),
  ('00000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000000',
   ...
   '{"provider":"email","providers":["email"]}', '{"nome":"Gestora do Workspace"}', now(), now(), '', '', '', ''),
  ('00000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000000',
   ...
   '{"provider":"email","providers":["email"]}', '{"nome":"Membro da Equipe"}', now(), now(), '', '', '', ''),
  ('00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000000',
   ...
   '{"provider":"email","providers":["email"]}', '{"nome":"Admin do Outro Workspace"}', now(), now(), '', '', '', '');
...
update public.perfis set admin = true where id = '00000000-0000-0000-0000-000000000001';

-- Dois workspaces isolados: quem está num não enxerga nada do outro.
insert into public.workspaces (id, codigo, nome) values
  ('20000000-0000-0000-0000-000000000001', 'PHD', 'PHD Engenharia'),
  ('20000000-0000-0000-0000-000000000002', 'OUTRA', 'Outra Empresa');

insert into public.membros_workspace (workspace_id, user_id, papel) values
...
insert into public.obras (id, workspace_id, codigo, nome) values
